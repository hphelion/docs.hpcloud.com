...
add-docs:
	git subtree add -P content/documentation https://git.hpcloud.net/DevExDocs/documentation.git master

update-docs:
	git subtree pull -P content/documentation https://git.hpcloud.net/DevExDocs/documentation.git master
