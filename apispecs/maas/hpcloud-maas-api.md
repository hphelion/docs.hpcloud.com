...
JSON representations are supported for requests and responses.### 4.1 Service API Operations**Host**: https://az-1.region-a.geo-1.mon.hpcloudsvc.com**BaseUri**: {Host}/v1.0### Version Operations

| Resource | Operation                                          | HTTP Method | Path                            | JSON/XML Support? | Privilege Level |
| :------- | :------------------------------------------------- | :---------- | :------------------------------ | :---------------- | :-------------- |
| Version | List all versions | GET | / | Y/Y ||
| Version | Get a specific version | GET | /*version_id* | Y/Y ||### Endpoint Operations

| Resource | Operation                                          | HTTP Method | Path                            | JSON/XML Support? | Privilege Level |
| :------- | :------------------------------------------------- | :---------- | :------------------------------ | :---------------- | :-------------- |
| Endpoint | Create a new endpoint | POST | /endpoints | Y/Y ||
| Endpoint | List all endpoints | GET | /endpoints | Y/Y ||
| Endpoint | Get a specific endpoint | GET | /endpoints/*endpoint_id* | Y/Y ||
| Endpoint | Delete a specific endpoint | DELETE | /endpoints/*endpoint_id* | Y/Y ||
| Endpoint | Reset the password for a specific endpoint | POST | /endpoints/*endpoint_id*/reset-password | Y/Y ||

### Subscription Operations

| Resource | Operation                                          | HTTP Method | Path                            | JSON/XML Support? | Privilege Level |
| :------- | :------------------------------------------------- | :---------- | :------------------------------ | :---------------- | :-------------- |
| Subscription | Create a new subscription | POST | /subscriptions | Y/Y ||
| Subscription | List all subscriptions | GET | /subscriptions | Y/Y ||
| Subscription | Get a specific subscription | GET | /subscriptions/*subscription_id* | Y/Y ||
| Subscription | Delete a specific subscription | DELETE | /subscriptions/*subscription_id* | Y/Y ||

### Notification Method Operations

| Resource | Operation                                          | HTTP Method | Path                            | JSON/XML Support? | Privilege Level |
| :------- | :------------------------------------------------- | :---------- | :------------------------------ | :---------------- | :-------------- |
| Notification Method | Create a new notification method | POST | /notification-methods | Y/Y ||
| Notification Method | List all notification methods | GET | /notification-methods | Y/Y ||
| Notification Method | Get a specific notification method | GET | /notification-methods/*notification_method_id* | Y/Y ||
| Notification Method | Delete a specific notification method | DELETE | /notification-methods/*notification_method_id* | Y/Y ||

### Alarm Operations

| Resource | Operation                                          | HTTP Method | Path                            | JSON/XML Support? | Privilege Level |
| :------- | :------------------------------------------------- | :---------- | :------------------------------ | :---------------- | :-------------- |
| Alarm | Create a new alarm | POST | /alarms | Y/Y ||
| Alarm | List all alarms | GET | /alarms | Y/Y ||
| Alarm | Get a specific alarm | GET | /alarms/*alarm_id* | Y/Y ||
| Alarm | Delete a specific alarm | DELETE | /alarms/*alarm_id* | Y/Y ||  
